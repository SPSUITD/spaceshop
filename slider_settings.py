...
class Slider:
    def __init__(self, x, y, width, height, slider_color, thumb_color, start_value, stop_value, step=1):
        ...
        self.font = pygame.font.SysFont('font/agat-8.ttf', 54)
    ...
    def draw(self, screen):
        ...
        screen.blit(text, (self.x + self.width + text.get_width(), self.y))
    ...
    def set_value(self, value):
        self.value = max(self.start_value, min(self.stop_value, value))
        self.thumb_x = self.x + (self.value - self.start_value) / (self.stop_value - self.start_value) * self.width
...
#
# slider_mem_product = Slider(100, 300, 200, 20, (100, 100, 100), (200, 200, 200), 1, 10)
#
#
#
# while True:
